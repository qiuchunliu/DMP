...
object BaiduMap {
  /**
    ...
    * @param lat 纬度
    */
  def parseBusinessTagBy(lng: String, lat: String): String = {
    var business: String = ""
    val requestParams: String = requetParams(lng, lat)
  ...
  private def requetParams(lng: String, lat: String) = {
    ...
    val list  ="G7CV6kGRbGgRg0N76zY2WsTCiCDlxXmO,S0qCOTpIcIOZ6adWxzKE8jfCDGCCbe1B"
  ...
  private def MD5(md5: String): String = {
    try {
      val md: MessageDigest = java.security.MessageDigest.getInstance("MD5")
